...
import { approveOrderEdit, createOrder, getAdminOrders, getMyOrders, rejectOrderEdit, requestOrderEdit, updateAdminOrder, updateOrderStatus } from '../controllers/order.controller';
import { optionalAuth, requireAdmin, requireAuth } from '../middleware/auth';
import { validateBody } from '../middleware/validateRequest';
import { adminOrderUpdateSchema, orderEditDecisionSchema, orderEditRequestSchema, orderSchema, orderStatusSchema } from '../validators/order.validator';
...
router.patch('/admin/:id', requireAuth, requireAdmin, validateBody(adminOrderUpdateSchema), updateAdminOrder);
